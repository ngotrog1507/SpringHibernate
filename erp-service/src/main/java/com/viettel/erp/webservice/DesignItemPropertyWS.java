...
public interface DesignItemPropertyWS {
    ...
    public List<DesignItemPropertyDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(DesignItemPropertyDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(DesignItemPropertyDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<DesignItemPropertyDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<DesignItemPropertyDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
