...
public interface CatDesignItemWS {
    ...
    public List<CatDesignItemDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(CatDesignItemDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(CatDesignItemDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<CatDesignItemDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<CatDesignItemDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
