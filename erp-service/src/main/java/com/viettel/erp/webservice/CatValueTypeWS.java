...
public interface CatValueTypeWS {
    ...
    public List<CatValueTypeDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(CatValueTypeDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(CatValueTypeDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<CatValueTypeDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<CatValueTypeDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
