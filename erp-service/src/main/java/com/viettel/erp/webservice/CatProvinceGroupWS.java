...
public interface CatProvinceGroupWS {
    ...
    public List<CatProvinceGroupDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(CatProvinceGroupDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(CatProvinceGroupDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<CatProvinceGroupDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<CatProvinceGroupDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
