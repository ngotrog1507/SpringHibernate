...
public interface ActIdUserWS {
    ...
    public List<ActIdUserDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(ActIdUserDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(ActIdUserDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<ActIdUserDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<ActIdUserDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
