...
public interface DesignItemTablePropertyWS {
    ...
    public List<DesignItemTablePropertyDTO> getAll()  throws java.lang.Exception;

    @WebMethod(operationName = "getOneById")
    BaseFWDTOImpl getOneById(Long costCenterId)  throws Exception;

    @WebMethod(operationName = "save")
    Long save(DesignItemTablePropertyDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "delete")
    void delete(DesignItemTablePropertyDTO costCenterBO) throws Exception;

    @WebMethod(operationName = "searchByHql")
    List<DesignItemTablePropertyDTO> searchByHql(String hql, List<ConditionBean> conditionBeans) throws Exception;

    @WebMethod(operationName = "searchByHql2")
    List<DesignItemTablePropertyDTO> searchByHql(String hql, List<ConditionBean> conditionBeans, int startIdx, int endIdx)
    throws Exception;
