...
<div class="form-horizontal" style="padding: 5px">
    <div class="form-group">
        ...
        <label class="control-label col-md-2">
            <fmt:message key="constrConsult.label.loaiTiepDien"/>
        </label>
        <div class="col-md-4 ">
            <select class="form-control">
                <option value="2"><fmt:message key="constrConsult.label.dongCoc"/></option>
                <option value="3"><fmt:message key="constrConsult.label.ho"/></option>
                <option value="4"><fmt:message key="constrConsult.label.khoangThaCoc"/></option>              
