...
public class Base64Utils {
	...
	public static boolean encodeToFile(byte[] dataToEncode, String filename) {
		...
		try {
			bos = new Base64Utils.OutputStream(new java.io.FileOutputStream(
					filename), Base64Utils.ENCODE);
	...
	public static boolean encodeFileToFile(String infile, String outfile) {
		...
		try {
			in = new Base64Utils.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(infile)), Base64Utils.ENCODE);
	...
	public static boolean decodeFileToFile(String infile, String outfile) {
		...
		try {
			in = new Base64Utils.InputStream(new java.io.BufferedInputStream(
					new java.io.FileInputStream(infile)), Base64Utils.DECODE);
			out = new java.io.BufferedOutputStream(
					new java.io.FileOutputStream(outfile));
			byte[] buffer = new byte[65536]; // 64K
